...
tags: ['ektron']
source: hugo
originalUrl: 'https://codifice.dev/posts/2010-04-22-fixing-precompilation-marker-file/'
...
It’s important that these handlers are registered prior to any wildcard handlers (path=”_._”) and is mapped to the standard ASP.Net handler.  If it’s mapped to the Ektron EkDavHttpHandlerFactory then the html and htm files will be served as text and not processed as a serverside page.
