...
description: 'Why developing against Ektron CMS by integrating into the workarea Web Site Project has significant drawbacks, and three alternative approaches for building websites with Ektron.'
pubDate: 2010-03-22
updatedDate: 2010-03-29
tags: ['ektron']
source: blogger
originalUrl: 'http://martinondotnet.blogspot.com/2010/03/working-with-ektron-using-web.html'
heroImage: ../../assets/blog/hero-images/2010-03-22-working-with-ektron-using-web.jpg
---

Like a lot of enterprise CMS products Ektron expects you to work in a particular way and provides lots of help for non-developers to quickly produce websites with minimal technical skills. But what if you have more technical needs?
...
Now, there are pros and cons on Web Site over Web Application projects but the big disadvantage for me is the sheer size of the workarea brings Visual Studio to a crawl when you're editing code. This is (partly) because of the background compilation that happens in the background to support IntelliSense.

There's also some Best Practice issues:

- **Code Standards**: By 'inheriting' all of the 3rd Party code into your code base you've also limited your ability to ensure that **_your_** code works properly. Static Analysis rules.
...
- **Security**: By integrating into the 3rd Party code you've increased the Surface Area for attackers. If your public facing website isn't properly secured there are several Google queries that can be run by hackers to find your site (and even the deployed version). _(You can stop this by properly configuring your robots.txt – it won't make your website bullet proof, but it will be harder for hackers/bots to find you! And change your default admin account!)_

So to my mind, there are three ways of developing against Ektron:

- **Work within the workarea website**: If you're working on a small site, don't currently apply any best practice processes in your build process (_or you may have a monster development PC_). You'll be able to leverage all of the built in Ektron functionality with minimal work.
