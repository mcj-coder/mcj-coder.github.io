...
description: 'Step-by-step guide to migrating source control history from TFS 2008 to Subversion 1.6 using a patched version of the tfs2svn tool.'
pubDate: 2011-05-10
tags: ['devops']
source: blogger
originalUrl: 'http://martinondotnet.blogspot.com/2011/05/migrating-from-tfs-2008-to-svn-16-with.html'
heroImage: ../../assets/blog/hero-images/2011-05-10-migrating-from-tfs-2008-to-svn-16-with.jpg
---

This is tricky because [tfs2svn](http://sourceforge.net/projects/tfs2svn/) stopped being updated when subversion 1.4 ruled the roost.
...
- Build 'tfs2svn.WinForms' and copy the output over the contents of 'C:\Program Files (x86)\Kevin Colyar\tfs2svn' _apart from the 'libs' folder_.
